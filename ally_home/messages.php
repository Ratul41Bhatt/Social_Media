       ...
       <div class="col-sm-6">
          <div class="load_msg" id="scroll_messages">
             ...
             $sel_msg = "select * from user_messages where (user_to ='$user_to_msg' AND user_from = '$user_from_msg') OR (user_from ='$user_to_msg' AND user_to ='$user_from_msg') ORDER by 1 ASC";
          	...
          	?>
          	<div id="loaded_msg">
          		<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){echo"<div class='message' id='blue' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";} else if($user_from == $user_to_msg AND $user_to == $user_from_msg){
...
<?php
   if(isset($_POST['msg_box']))
   {
    $msg = htmlentities($_POST['msg_box']);
     ...
     echo"<h4 style='color: red;text-align: center;'>Message was too long!Use only 37 character</h4>";
     }else{
      ...
      <div class='row'>
         ...
         <center>
            <div style='background-color: #e6e6e6 ;' class='col-sm-9'>
              ...
              <img class='img-circle' src='users/$user_image' width='120px' height='120px'><br><br>
              <ul class='list-group'>
                 <li class='list-group-item' title='Username'><strong>$f_name $l_name</strong></li>
                  ...
                  <li class='list-group-item'  title='User Registration Date'>Joined:$register_date</li>
              </ul>
            </div>
            <div class='col-sm-1'>
